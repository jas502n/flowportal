...
Ext.define('YZSoft.apps.dailyreport.team.Main', {
    extend: 'Ext.Container',
    requires: [
        'YZSoft.apps.dailyreport.model.DailyReportTeam'
    ],
    config: {
        account: null,
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.Store', {
            model: 'YZSoft.apps.dailyreport.model.DailyReportTeam',
            autoLoad: false,
            loadDelay: false,
        ...
        me.store.on({
            load: function () {
                var count = me.store.getCount(),
                    title = count ? Ext.String.format(RS.$('DeilyReport_Team_Title_FMT'), count) : RS.$('DeilyReport_Team_Title');
    ...
    onItemTap: function (target, record) {
        ...
        pnl = Ext.create('YZSoft.apps.dailyreport.panel.DailyReport', {
            title: Ext.String.format(RS.$('DailyReport_Personal_Title'),record.data.ShortName),
            account: uid,
            date: date,
            editable:false,
            back: function () {
