...
Ext.define('YZSoft.apps.monthlyreport.team.Main', {
    extend: 'Ext.Container',
    requires: [
        'YZSoft.apps.monthlyreport.model.MonthlyReportTeam'
    ],
    config: {
        account: null,
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.Store', {
            model: 'YZSoft.apps.monthlyreport.model.MonthlyReportTeam',
            autoLoad: false,
            loadDelay: false,
        ...
        me.store.on({
            load: function () {
                var count = me.store.getCount(),
                    title = count ? Ext.String.format(RS.$('MonthlyReport_Team_Title_FMT'), count) : RS.$('MonthlyReport_Team_Title');
    ...
    onItemTap: function (target, record) {
        ...
        pnl = Ext.create('YZSoft.apps.monthlyreport.panel.MonthlyReport', {
            title: Ext.String.format(RS.$('MonthlyReport_Personal_Title'),record.data.ShortName),
            account: uid,
            date: date,
            editable:false,
            back: function () {
