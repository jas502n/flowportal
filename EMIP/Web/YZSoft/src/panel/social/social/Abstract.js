Ext.define('YZSoft.src.panel.social.social.Abstract', {
    extend: 'YZSoft.src.panel.social.base.Abstract',
    requires: [
    ...
    onCapturePhotoClick: Ext.emptyFn,
    onCaptureVideoClick: Ext.emptyFn,
    ...
    createMediaPanel: function () {
        ...
        pnl = Ext.create('Ext.Container', {
            ...
            items: [{
                ...
                handler: function () {
                    me.onCapturePhotoClick();
                }
            }, {
                xtype: 'component',
                hidden: application.captureVideo === false,
                flex: 2
            }, {
                text: RS.$('All__Video'),
    ...
    send: function (msg,clearComments) {
        var me = this,
            resType = me.getResType(),
            resId = me.getResId(),
            msg = msg == undefined ? me.txtComments.getValue():msg;
