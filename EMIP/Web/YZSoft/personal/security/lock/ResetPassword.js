...
Ext.define('YZSoft.personal.security.lock.ResetPassword', {
                ...
                me.pnl2.edtPassword.on({
                    fullinputed: function (password2) {
                        ...
                        YZSoft.Ajax.request({
                            ...
                            params: {
                                Method: 'ResetScreenLockPassword',
                                userPassword: me.getUserPassword(),
                                newPassword: password2
                            },
                            waitMsg: {
                                message: RS.$('All_ScreenLock_ResetPassword_Mask'),
                                autoClose: false
                            },
                            delay: true,
                            success: function (action) {
                                Ext.Viewport.mask(Ext.apply({
                                    cls: 'yz-mask-success',
                                    message: RS.$('All_ScreenLock_ResetPassword_Success'),
                                    delay: true,
                                    fn: function () {
                                        if (me.config.fn)
                            ...
                            failure: function (action) {
                                Ext.Msg.alert(RS.$('All_ScreenLock_ResetPassword_Title_Failed'), action.result.errorMessage);
                            }
                        });
                    }
                });
