...
/// </summary>
public partial class YZExcelGenerate : YZExcelGenerateBase
{
    #region 对外服务
    ...
    {
        MethodInfo method = typeof(YZExcelGenerate).GetMethod(RenderFunction, BindingFlags.Static | BindingFlags.NonPublic | BindingFlags.Public);
        if (method == null)
        {
