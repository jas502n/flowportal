...
/// </summary>
public class YZExcelHelper2003
{
    ...
    public static object GetCellValue(HSSFFormulaEvaluator evaluator,HSSFCell cell)
    {
        ...
        switch (cell.CellType)
        {
            ...
            case CellType.FORMULA:
                ...
                {
                    string err = String.Format(Resources.YZStrings.Aspx_Excel_Ext_Invalid_Express, YZExcelHelper.ColumnIndexToName(cell.ColumnIndex) + (cell.RowIndex + 1).ToString(), cell.CellFormula);
