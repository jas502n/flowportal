...
namespace YZSoft.Web.Word
{
    public partial class WordGenerator
    {
        ...
        static List<XWPFTable> GetAllTables(XWPFDocument doc)
        {
        ...
        static List<XWPFParagraph> GetAllParagraphs(XWPFDocument doc)
        {
        ...
        private static bool HasMergeField(IList<XWPFParagraph> phs)
        {
            foreach (XWPFParagraph ph in phs)
            {
                if (HasMergeField(ph))
        ...
        private static int GetObjectIndex(List<DocumentBodyItemChoiceType> names, DocumentBodyItemChoiceType type, int p)
        {
            int num2 = 0;
