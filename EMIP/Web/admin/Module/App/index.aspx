        ...
        layui.config({
            ...
            table.render({
                elem: '#applist'
                  ...
                  , title: '主页App列表'
                  , cols: [[
                    { field: 'AppName', title: '应用名称', width: 200, fixed: 'left', unresize: true }
                    ...
                    , { field: 'IconColor', title: '图标颜色', width: 100 }
                    , { field: 'IconSize', title: '图标大小', width: 100 }
                    , { field: 'BADGE', title: '角标', width: 150 }
                      , { field: 'ViewType', title: '应用分类', width: 120 }
                     , { field: 'Type', title: '页面类别', width: 100 }
                    , { field: 'AppUrl', title: '应用路径' }
                    , {
                        field: 'Enable', title: '是否启用', width: 90, templet: function (d) {
                            return d.Enable == "True" ? "是" : "否";
                        }
                    }
